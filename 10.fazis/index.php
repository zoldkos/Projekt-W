...
<html lang="hu">
  ...
  <body>
    ...
    <?php // A menüpontot ellenőrizzük a GET paraméter alapján Á +Switch-case,
        ...
        switch ($menu) {
            ...
            case 'szolgaltatasok':
                ...
                break;
            case 'galeria':
                include 'galeria.php'; // Például 'galeria.html' tartalmát jelenítjük meg Á,
                break;
            case 'kapcsolat':
    ...
    <section><!-- video sajat forrasbol Á, -->
      <div class="video-sajatforras"> 
